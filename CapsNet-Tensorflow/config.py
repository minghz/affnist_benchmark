...
flags.DEFINE_string('peppered', 30, 'affmnist peppered with transformed images of such percentage')
...
flags.DEFINE_integer('save_freq_step', 10, 'the frequency of saving model(step)')
